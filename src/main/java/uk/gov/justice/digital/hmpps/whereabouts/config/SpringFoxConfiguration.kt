...
class SpringFoxConfiguration {
  ...
  fun api(): Docket? {
    ...
    val docket = Docket(DocumentationType.OAS_30)
      ...
      .apiInfo(apiInfo)
      .select()
      .apis(RequestHandlerSelectors.basePackage(AttendanceController::class.java.getPackage().name))
      .paths(PathSelectors.any())
      .build()
    docket.genericModelSubstitutes(Optional::class.java)
    docket.directModelSubstitute(ZonedDateTime::class.java, String::class.java)
    docket.directModelSubstitute(LocalDateTime::class.java, String::class.java)
    docket.directModelSubstitute(LocalDate::class.java, String::class.java)
    docket.directModelSubstitute(LocalTime::class.java, String::class.java)
    return docket
  }

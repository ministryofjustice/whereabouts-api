...
class AttendancesController(private val attendanceService: AttendanceService) {
  ...
  @ApiOperation(
    value = "Create new attendance records for multiple offenders (This endpoint does not trigger IEP warnings)",
  ...
  @ApiOperation(
    value = "Returns set of attendance details",
    response = AttendancesResponse::class,
  ...
  fun getAttendanceForEventLocation(
    ...
    @ApiParam(
      value = "Date of event in format YYYY-MM-DD",
      required = true
  ...
  @ApiOperation(
    value = "Returns set of attendance details for attendances with an absent reason",
    response = AttendancesResponse::class,
  ...
  @GetMapping("/{prison}")
  @ApiOperation(
    value = "Returns set of attendance details for set of booking ids",
    response = AttendancesResponse::class,
    notes = "Request attendance details"
  )
  ...
  fun getAttendanceForBookingsOverDateRangeByPost(
    ...
    @ApiParam(value = "Date of event in format YYYY-MM-DD defaults to fromDate") @RequestParam(name = "toDate") @DateTimeFormat(
      iso = DATE
    ) toDate: LocalDate?,
  ...
  @ApiOperation(
    value = "Return a set of attendance details for all offenders that have scheduled activity",
    response = AttendancesResponse::class,
    notes = "Request attendance details"
  )
  ...
  @ApiOperation(
    value = "Return a set of absences for all offenders that have scheduled activity",
    response = AbsencesResponse::class,
    notes = "Request absences"
  )
  ...
  fun getAttendanceChanges(
    @ApiParam(
      value = "Date and Time of change in format YYYY-MM-DDT09:10",
      required = true

...
class LocationServiceTest {
  ...
  @Test
  fun `getVideoLinkRoomsForPrison - filter by type then return Ids and descriptions`() {
    ...
    val location2 = Location(
      ...
      agencyId = "MDI", parentLocationId = 123, currentOccupancy = 2, locationPrefix = "MDI-prefix",
      operationalCapacity = 2, userDescription = null, internalLocationCode = "Room 2"
    )

    val location3 = Location(
      locationId = 3, locationType = "MEETING ROOM", description = "Video Room C", locationUsage = "APP",
      agencyId = "MDI", parentLocationId = 123, currentOccupancy = 2, locationPrefix = "MDI-prefix",
      operationalCapacity = 2, userDescription = null, internalLocationCode = "Room 3"
    )
